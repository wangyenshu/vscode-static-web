...
let errMsg = 'Do not assign variables to HTMLScriptElement#src, as this can lead to XSS.';
/**
...
class Rule extends conformance_pattern_rule_1.ConformancePatternRule {
    constructor(configuration = {}) {
        super((0, pattern_config_1.overridePatternConfig)(Object.assign(Object.assign({ errorCode: conformance_pattern_rule_1.ErrorCode.CONFORMANCE_PATTERN, errorMessage: errMsg, kind: conformance_pattern_rule_1.PatternKind.BANNED_PROPERTY_WRITE, values: ['HTMLScriptElement.prototype.src'] }, configuration), { name: Rule.RULE_NAME, allowedTrustedType: trusted_types_configuration_1.TRUSTED_SCRIPT_URL })));
    }
}
exports.Rule = Rule;
Rule.RULE_NAME = 'ban-script-src-assignments';
//# sourceMappingURL=ban_script_src_assignments.js.map