...
let errMsg = 'Constructing shared Web Workers can cause code to be loaded from an untrusted URL.';
/**
...
class Rule extends conformance_pattern_rule_1.ConformancePatternRule {
    constructor(configuration = {}) {
        super((0, pattern_config_1.overridePatternConfig)(Object.assign({ errorCode: conformance_pattern_rule_1.ErrorCode.CONFORMANCE_PATTERN, errorMessage: errMsg, kind: conformance_pattern_rule_1.PatternKind.BANNED_NAME, values: ['GLOBAL|SharedWorker'], name: Rule.RULE_NAME, allowedTrustedType: trusted_types_configuration_1.TRUSTED_SCRIPT_URL }, configuration)));
    }
}
exports.Rule = Rule;
Rule.RULE_NAME = 'ban-shared-worker-calls';
//# sourceMappingURL=ban_shared_worker_calls.js.map