...
class Rule extends conformance_pattern_rule_1.ConformancePatternRule {
    constructor(configuration = {}) {
        super((0, pattern_config_1.overridePatternConfig)(Object.assign({ errorCode: conformance_pattern_rule_1.ErrorCode.CONFORMANCE_PATTERN, errorMessage: errMsg, kind: conformance_pattern_rule_1.PatternKind.BANNED_PROPERTY, values: ['Document.prototype.writeln'], name: Rule.RULE_NAME, allowedTrustedType: trusted_types_configuration_1.TRUSTED_HTML }, configuration)));
    }
}
exports.Rule = Rule;
Rule.RULE_NAME = 'ban-document-writeln-calls';
//# sourceMappingURL=ban_document_writeln_calls.js.map