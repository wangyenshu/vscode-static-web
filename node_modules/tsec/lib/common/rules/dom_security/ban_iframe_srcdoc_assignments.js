...
let errMsg = 'Assigning directly to HTMLIFrameElement#srcdoc can result in XSS vulnerabilities.';
/**
...
class Rule extends conformance_pattern_rule_1.ConformancePatternRule {
    constructor(configuration = {}) {
        super((0, pattern_config_1.overridePatternConfig)(Object.assign({ errorCode: conformance_pattern_rule_1.ErrorCode.CONFORMANCE_PATTERN, errorMessage: errMsg, kind: conformance_pattern_rule_1.PatternKind.BANNED_PROPERTY_WRITE, values: ['HTMLIFrameElement.prototype.srcdoc'], name: Rule.RULE_NAME, allowedTrustedType: trusted_types_configuration_1.TRUSTED_HTML }, configuration)));
    }
}
exports.Rule = Rule;
Rule.RULE_NAME = 'ban-iframe-srcdoc-assignments';
//# sourceMappingURL=ban_iframe_srcdoc_assignments.js.map