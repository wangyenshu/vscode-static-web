...
let errMsg = 'Do not use ServiceWorkerContainer#register, as this can lead to XSS.';
/**
...
class Rule extends conformance_pattern_rule_1.ConformancePatternRule {
    constructor(configuration = {}) {
        super((0, pattern_config_1.overridePatternConfig)(Object.assign({ errorCode: conformance_pattern_rule_1.ErrorCode.CONFORMANCE_PATTERN, errorMessage: errMsg, kind: conformance_pattern_rule_1.PatternKind.BANNED_PROPERTY, values: ['ServiceWorkerContainer.prototype.register'], name: Rule.RULE_NAME, allowedTrustedType: trusted_types_configuration_1.TRUSTED_SCRIPT_URL }, configuration)));
    }
}
exports.Rule = Rule;
Rule.RULE_NAME = 'ban-serviceworkercontainer-register';
//# sourceMappingURL=ban_serviceworkercontainer_register.js.map