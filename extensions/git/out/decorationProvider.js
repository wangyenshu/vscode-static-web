...
class GitIncomingChangesFileDecorationProvider {
    constructor(repository) {
        ...
        this.decorations = new Map();
        this.disposables = [];
        this.disposables.push(vscode_1.window.registerFileDecorationProvider(this), (0, util_1.runAndSubscribeEvent)(repository.historyProvider.onDidChangeCurrentHistoryItemGroup, () => this.onDidChangeCurrentHistoryItemGroup()));
    }
    async onDidChangeCurrentHistoryItemGroup() {
        const newDecorations = new Map();
