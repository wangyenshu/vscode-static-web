...
var _tsParser, _tsxParser, _tsGrammar, _tsxGrammar, _getCommentsFromMatch, getCommentsFromMatch_fn, _getStringFromMatch, getStringFromMatch_fn, _getUnquotedString, getUnquotedString_fn, _getImportDetails, getImportDetails_fn;
...
getCommentsFromMatch_fn = function(match) {
  ...
  return commentCapture.node.children.filter((c) => c.type === "string").map((c) => __privateMethod(this, _getUnquotedString, getUnquotedString_fn).call(this, c.text));
};
